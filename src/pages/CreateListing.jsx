...
const CreateListing = () => {
  ...
  return (
    <>
      ...
      <div>
        <div className="container flex pt-14 gap-20 max-md:gap-8">
          <Sidebar />
            ...
            >
              ...
              <div className="border p-4 w-full mb-4">
                <div className="flex flex-wrap md:flex-row gap-16 max-lg:gap-8 justify-center">
                  ...
                  <div className="max-lg:mb-8 my-4 max-lg:my-0">
                ...
                <div className="flex items-center gap-6 flex-wrap justify-center mt-4 mb-2">
                  <div className="">
              ...
              <div className="w-full">
                ...
                <div
                  className="uploader rounded-3xl w-full min-h-[150px] flex items-center justify-center gap-2
